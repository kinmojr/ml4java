...
/**
 * # 3.6.2 手書き数字認識 ニューラルネットワークの推論処理.
 * MNISTの手書き文字をニューラルネットワークで判別する.
 */
public class Chap3NeuralNetwork {
    /**
     * 重みデータ.
     */
    ...
    public static void main(String... args) throws IOException, ClassNotFoundException {
        Chap3NeuralNetwork neuralNetwork = new Chap3NeuralNetwork();
     ...
     */
    public Chap3NeuralNetwork() throws IOException, ClassNotFoundException {
        // 学習済みの重みデータを読み込む
        // 784*50
    ...
    private void execute() {
        ...
        for (int i = 0; i < features.getRowDimension(); i++) {
            double[] y = predict(features.getRowMatrix(i), w, b);
